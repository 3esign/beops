...
The source registry is an inventory of access routes, not a bibliography or count of devices. New literature lives in an additive wide-bibliography supplement. Agent output is reviewed before acceptance, with citation/title and local-device claims checked independently. Record accepted records, corrected claims, duplicates and blocks; model costs are unavailable. No claims of complete literature coverage or verified live feeds from a paper alone.
