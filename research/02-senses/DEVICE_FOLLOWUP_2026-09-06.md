...
The [follow-up board](../_trail/DEVICE_FOLLOWUP_BOARD_2026-09-06.md) records the request budget, integration checks and worker release. Original receipts and failed responses remain immutable. The [recent-chart QA](../evidence/device-followup-20260906/RECORD168_STATIC_QA.json), [lidar metadata QA](../evidence/device-followup-20260906/ACTRIS_METADATA_QA.json) and [DOI map](../evidence/device-followup-20260906/WEBASOOP_DOI_MAP.json) retain exact inputs and distinctions. The [Plovput review](PLOVPUT_BULLETIN_2026-09-06.md) explains its collection hold.
