...
Belgrade evidence observatory. A new implementation in the Living City Brain / Urban Intelligence collection.

Status: research-first foundation, 2026-09-05. The previous application is archival material, not the runtime. Existing server, model adapter and public/ files are inactive, unvalidated technical sketches. Interface development is paused; the research product may have no interface.

The planned first version connects parking, public events/service changes, documented prices and environmental observations through existing sources. Forecasts and archival context are separate channels. It must distinguish observations, forecasts, model estimates, and unavailable data. No fabricated camera readings, river levels, city vitality score, face recognition, individual tracking, or unsupported causal claims.
...
Current discussion pack: [Serbian pre-paper V2](research/06-paper/PRED_RAD_SR_V2_2026-09-06.md), including [verified institutional practices](research/06-paper/UVOD_PROVERENE_PRAKSE_SR_2026-09-06.md), [24-publication literature extension](research/04-bibliography/DOPUNA_LITERATURE_SR_V2_2026-09-06.md) and [all189 source records in Serbian](research/06-paper/ATLAS_IZVORA_SR_2026-09-06.md). Semir requests Serbian working material now and eventual English/Serbian alignment later. The [earlier English pack](research/06-paper/PRE_PAPER_URBAN_INTELLIGENCE_2026-09-06.md) is preserved as a prior version, not a synchronized translation. Manuscript drafting remains paused.
...
- [Source registry](research/SOURCE_REGISTRY.json): 189 source records, including archives, catalogues and coverage gaps. This is not a count of devices or live feeds.
...
No public deployment or conference submission has occurred.
