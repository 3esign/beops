...
checks.push({name:'Svemir header provider (publication transport only; sources see Beops-Research-Collect/1.0)',ok:[process.env.BEOPS_INCOGNITO,'C:/Svemir/lib/incognito.js','D:/Svemir/lib/incognito.js'].filter(Boolean).some(p=>fs.existsSync(p))});
