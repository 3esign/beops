...
.stage{position:relative;width:min(1600px,calc(100% - 2*var(--u)*4));margin:0 auto;height:min(82vh,900px);border:1px solid var(--ink12);border-radius:6px;overflow:hidden;background:var(--field);box-shadow:0 30px 60px -40px rgba(17,19,17,.5)}
...
@media (max-width:900px){
  ...
  .stage{height:min(88vh,760px);width:calc(100% - 2*var(--u)*3)}
