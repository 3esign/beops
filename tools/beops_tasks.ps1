...
function Get-BeopsTaskSpecs {
  return @(
    ...
    [pscustomobject]@{ Name='Beops_Publish';  Bat='tools\publish_tick.bat';  Minutes=30;    OffsetMinutes=10; Limit=30; Desc='BEOPS: export and push the public site (github.com/3esign/beops)' },
