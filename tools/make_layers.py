...
def build(c: dict, small: bool = False) -> str:
    ...
    strata = [
        ...
        ("mind", "6 · Sistem koji misli i govori", "6 · The system that thinks and speaks", "tri entiteta · kapija", "three entities · a gate",
         "Posmatrač, Sumnjalo i Povezivač na lokalnim modelima, glas na ekavici · kapija: brojevi samo iz digesta",
         "Observer, Skeptic and Connector on local models, a voice in ekavian Serbian · the gate: numbers only from the digest",
         idiom_mind, True),
