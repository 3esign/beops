...
def build(c: dict, small: bool = False) -> str:
    ...
    strata = [
        ...
        "Posmatrač, Sumnjalo i Povezivač na automatski izabranim proverenim modelima · kapija: brojevi samo iz digesta, citati u tekstu",
        "Observer, Skeptic and Connector on automatically selected reviewed models · the gate: numbers only from the digest, citations in the text",
         idiom_mind, True),
